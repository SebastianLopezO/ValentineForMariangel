    ...
    return (
        <div className="relative w-full max-w-md mx-auto">
            <svg viewBox="0 0 400 350" className="w-full h-auto">
                ...
                <rect x="175" y="230" width="10" height="40" rx="3" fill="hsl(170, 55%, 25%)"
                      transform="rotate(-30, 175, 230)"/>
                <rect x="215" y="240" width="8" height="35" rx="3" fill="hsl(170, 55%, 25%)"
                      transform="rotate(25, 215, 240)"/>
