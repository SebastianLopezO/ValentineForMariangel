    ...
    return (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-background">
            ...
            >
                {/* Envelope body */}
                <div
                    className="w-64 h-44 sm:w-80 sm:h-52 bg-rose-soft/30 rounded-lg border-2 border-primary/30 relative overflow-hidden transition-all duration-300 group-hover:border-primary/60 group-hover:shadow-[0_0_30px_hsl(340_80%_60%/0.3)]">
                    {/* Letter inside */}
                    <div
